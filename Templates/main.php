    ...
    <div class="container">
        ...
        <div>
          <form action="recorridos.php" method="post" onsubmit="return FilterValidation()">
            ...
            <div class="form-group">
              <label for="dtp_input3" class="col-md-2 control-label">Fecha de viaje</label>
                <div class="input-group date form_time id="dtp_input3" col-md-5" data-date="" data-date-format="dd-mm-yyyy hh:00:00" data-link-field="dtp_input3" data-link-format="hh:ii">
